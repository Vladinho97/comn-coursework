		...
		try {
			...
			while (true) {
				...
				synchronized (lock) {
					...
					System.out.println("packetSize : "+packetSize+"   |   IPAddress :"+IPAddress+"   |   clientPortNo : "+clientPortNo);
					...
					if (rcvSeqNo == expectedSeqNo && packetSize > 2) { // received packet is the right packet
						...
						System.out.println("IPAddress : "+IPAddress+"   |   clientPortNo : "+clientPortNo);
